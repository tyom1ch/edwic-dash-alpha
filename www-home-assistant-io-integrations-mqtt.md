...
**[Add Integration](https://my.home-assistant.io/redirect/config_flow_start?domain=mqtt)** button.
...
- [Date](https://www.home-assistant.io/integrations/date.mqtt/)
- [Date Time](https://www.home-assistant.io/integrations/datetime.mqtt/)
...
- [Time](https://www.home-assistant.io/integrations/time.mqtt/)
...
3. Add a subentry via [**Settings** \> **Devices & services**](https://my.home-assistant.io/redirect/integrations), select , and select **Add MQTT device**.
...
1. Go to **[Settings > Devices & services](https://my.home-assistant.io/redirect/integrations)**.
2. Select the MQTT integration.
3. Reconfigure the MQTT broker settings via [**Settings** \> **Devices & services**](https://my.home-assistant.io/redirect/integrations), select , and select **Reconfigure**.
...
See also [MQTT Discovery section](https://www.home-assistant.io/integrations/mqtt/#mqtt-discovery)
...
To disable discovery, or change the discovery QoS or prefix, see the [MQTT Options sections](https://www.home-assistant.io/integrations/mqtt/#configure-mqtt-options).
...
to trigger discovery messages. See also the [birth and last will messages](https://www.home-assistant.io/integrations/mqtt/#birth-and-last-will-messages)
...
The sensor [`identifiers` or `connections`](https://www.home-assistant.io/integrations/sensor.mqtt/#device) option allows you to set up multiple entities that share the same device.
...
If you have many manually configured items, you might want to consider [splitting up the configuration](https://www.home-assistant.io/docs/configuration/splitting_configuration/).
...
- [Provide feedback](https://github.com/home-assistant/home-assistant.io/issues/new?template=feedback.yml&url=https%3A%2F%2Fwww.home-assistant.io%2Fintegrations%2Fmqtt%2F&version=2026.6.4&labels=current,integration%3A%20mqtt "Provide feedback on this page")
