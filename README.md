...
Багато нових віджетів
✨ **Нові можливості**
- Додано віджет "Бінарний сенсор" (відкрито/закрито).
- Додано віджет "Світло" (з яскравістю/кольором).
- Додано віджет "Вентилятор".
- Додано віджет "Ролети / Ворота".
- Додано віджет "Число (Slider/Box)".

♻️ **Зміни**
- Оновлено конфігурацію та логіку віджета "Клімат-контроль".
- Віджет сенсора тепер адаптивно змінює розмір шрифту, щоб вмістити значення.
- Додано відображення останнього оновлення стану для перемикача.
- Додано можливість вибору режиму роботи (slider/box) для віджета "Число".
- UI: покращено загальний вигляд інтерфейсу та додано UX покращення.

🐛 **Виправлення**
- Виправлено проблему з некоректним визначенням типу віджета клімату.
- Виправлено масштабування тексту для сенсора.

🧹 **Внутрішні зміни**
- Реорганізовано структуру файлів: віджети переміщено в окрему папку.
- У конфігурації віджетів тепер використовуються об'єкти з ключами-аліасами.
- Видалено зайвий код та коментарі.
- Оновлено залежності.
- Додано user-select: none для елементів body для уникнення випадкового виділення тексту.
<!-- CHANGELOG END -->
