...
✨ **Нові можливості**
- Додано віджети: Бінарний сенсор, Вентилятор, Ролети/Ворота, Число (Slider/Box), Світло (з яскравістю/кольором).
- Додано можливість вибору "режиму відображення" (slider/box) для віджета "Число".

♻️ **Зміни**
- Перероблено систему конфігурації віджетів для більшої гнучкості та розширеності.
- У віджеті сенсора реалізовано адаптивне масштабування тексту, покращено відображення та додано скорочену назву.
- У віджеті перемикача додано відображення часу останнього оновлення.
- Внесені зміни в UI та покращено UX, зокрема: користувацький вибір заборонено, з'єднання встановлюється швидше.

🐛 **Виправлення**
- Виправлено помилки в логіці обробки подій та віджетів.
