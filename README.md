...
♻️ **Зміни**
- Оновлено конфігурацію існуючих віджетів для підтримки нових можливостей.
- Перероблено компонент `SensorComponent` для кращого масштабування тексту та адаптивного відображення.
- Додано нові поля конфігурації та аліаси для різних типів віджетів.
- Оновлено логіку обробки команд для нових віджетів.
- В компонент Switch додано відображення часу останнього оновлення.

🐛 **Виправлення**
- Виправлено помилки, пов'язані з відображенням та обробкою станів в різних віджетах.

🧹 **Внутрішні зміни**
- Додано обробку помилок на платформах без тактильного відгуку в `SwitchComponent`.
- Оновлено компоненти `MuiCssBaseline`, щоб уникнути проблем з виділенням тексту.
- Оновлено стилі UI та покращено UX.
- Виправлено помилки, пов'язані з невірною обробкою теми.
- Оновлено README.md.
<!-- CHANGELOG END -->
